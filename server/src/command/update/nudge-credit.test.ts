 ...
 * unanswerable. A release can carry a fix for a connect defect affecting every Vite app and be
 * installed by nobody, with nothing in the data to say whether the nudge or the fix was the
 * problem.
 *
